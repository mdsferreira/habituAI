...
export const config = {
  light: vars({
    ...
    '--color-primary-50': '239 230 250',
    '--color-primary-100': '213 194 240',
    '--color-primary-200': '184 151 230',
    '--color-primary-300': '156 107 219',
    '--color-primary-400': '156 107 219',
    '--color-primary-500': '111 35 204',
    '--color-primary-600': '99 28 199',
    '--color-primary-700': '87 19 189',
    '--color-primary-800': '72 9 181',
    '--color-primary-900': '44 9 171',
    '--color-primary-950': '26 9 48',

    /* Secondary  */
    '--color-secondary-0': '246 249 243',
    '--color-secondary-50': '26 9 48',
    '--color-secondary-100': '223 238 202',
    '--color-secondary-200': '204 225 168',
    '--color-secondary-300': '182 214 133',
    '--color-secondary-400': '167 205 107',
    '--color-secondary-500': '152 196 81',
    '--color-secondary-600': '137 180 73',
    '--color-secondary-700': '117 160 62',
    '--color-secondary-800': '97 140 54',
    '--color-secondary-900': '64 106 37',
    '--color-secondary-950': '41 56 20',
